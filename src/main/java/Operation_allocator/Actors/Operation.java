...
public class Operation implements Serializable {
    ...
    /**
     * Method to override to produce simulated output relation profile
     * typical of particular operation
     */
    ...
    public void setHomogeneousSet(List<Attribute> la){

    }

    public void setProjectedSet(List<Attribute> la){
